...
if($_POST)
{
    $to_Email       = "pillai@fas.harvard.edu"; // Replace with recipient email address
	$subject        = 'Contact form message from my personal website '.$_SERVER['SERVER_NAME']; //Subject line for emails
